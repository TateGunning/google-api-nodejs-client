...
export namespace texttospeech_v1 {
  ...
  export class Resource$Projects$Locations {
    context: APIRequestContext;
    voices: Resource$Projects$Locations$Voices;
    constructor(context: APIRequestContext) {
      this.context = context;
      this.voices = new Resource$Projects$Locations$Voices(this.context);
    }
  }

  export class Resource$Projects$Locations$Voices {
    context: APIRequestContext;
    constructor(context: APIRequestContext) {
      this.context = context;
    }
     ...
     *
     *   // Do the magic
     *   const res = await texttospeech.projects.locations.voices.synthesizeLongAudio({
     *     // The resource states of the request in the form of projects/x/locations/x/voices/x.
     *     parent: 'projects/my-project/locations/my-location/voices/my-voice',
     *
     *     // Request body metadata
     *     requestBody: {
     *       // request body parameters
     ...
     */
    synthesizeLongAudio(
      params: Params$Resource$Projects$Locations$Voices$Synthesizelongaudio,
      options: StreamMethodOptions
    ): GaxiosPromise<Readable>;
    synthesizeLongAudio(
      params?: Params$Resource$Projects$Locations$Voices$Synthesizelongaudio,
    ...
    synthesizeLongAudio(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Voices$Synthesizelongaudio
        | BodyResponseCallback<Schema$Operation>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      let params = (paramsOrCallback ||
        {}) as Params$Resource$Projects$Locations$Voices$Synthesizelongaudio;
      let options = (optionsOrCallback || {}) as MethodOptions;
  ...
  export interface Params$Resource$Projects$Locations$Voices$Synthesizelongaudio
    extends StandardParameters {
    /**
     * The resource states of the request in the form of projects/x/locations/x/voices/x.
     */
