...
export namespace integrations_v1alpha {
    ...
    generateToken(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/callback:generateToken').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    enumerate(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1alpha/connectorPlatformRegions:enumerate'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'GET',
          },
          options
  ...
  export class Resource$Projects$Locations$Appsscriptprojects {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/appsScriptProjects').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    link(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1alpha/{+parent}/appsScriptProjects:link'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
  ...
  export class Resource$Projects$Locations$Authconfigs {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/authConfigs').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Connections$Runtimeactionschemas {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/runtimeActionSchemas').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Connections$Runtimeentityschemas {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/runtimeEntitySchemas').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Integrations {
    ...
    execute(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:execute').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/integrations').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
    ...
    schedule(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:schedule').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Integrations$Executions {
    ...
    list(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/executions').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'GET',
  ...
  export class Resource$Projects$Locations$Integrations$Versions {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/versions').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    publish(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+name}:publish').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
    ...
    takeoverEditLock(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Integrations$Versions$Takeovereditlock
        | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaTakeoverEditLockResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (
              rootUrl + '/v1alpha/{+integrationVersion}:takeoverEditLock'
            ).replace(/([^:]\/)\/+/g, '$1'),
            method: 'POST',
          },
          options
  ...
  export class Resource$Projects$Locations$Products {
    ...
    constructor(context: APIRequestContext) {
      ...
      this.integrationtemplates =
        new Resource$Projects$Locations$Products$Integrationtemplates(
          this.context
        );
      this.sfdcInstances =
  ...
  export class Resource$Projects$Locations$Products$Certificates {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/certificates').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
  ...
  export class Resource$Projects$Locations$Products$Integrationtemplates {
    ...
    constructor(context: APIRequestContext) {
      this.context = context;
      this.versions =
        new Resource$Projects$Locations$Products$Integrationtemplates$Versions(
          this.context
        );
    }
  }
  ...
  export class Resource$Projects$Locations$Products$Integrationtemplates$Versions {
    ...
    create(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion>,
      callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion>
    ): void;
    create(
      params: Params$Resource$Projects$Locations$Products$Integrationtemplates$Versions$Create,
      callback: BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion>
    ...
    create(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Products$Integrationtemplates$Versions$Create
        | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion>(
          parameters
        );
      }
    }
    ...
    get(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Products$Integrationtemplates$Versions$Get
        | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaIntegrationTemplateVersion>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
    ...
    list(
      ...
      options:
        | MethodOptions
        | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse>,
    ...
    list(
      paramsOrCallback?:
        | Params$Resource$Projects$Locations$Products$Integrationtemplates$Versions$List
        | BodyResponseCallback<Schema$GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse>
        | BodyResponseCallback<Readable>,
      optionsOrCallback?:
        | MethodOptions
      ...
      if (callback) {
        createAPIRequest<Schema$GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse>(
          parameters,
          callback as BodyResponseCallback<unknown>
        );
      } else {
        return createAPIRequest<Schema$GoogleCloudIntegrationsV1alphaListIntegrationTemplateVersionsResponse>(
          parameters
        );
      }
    }
  ...
  export interface Params$Resource$Projects$Locations$Products$Integrationtemplates$Versions$Create
    extends StandardParameters {
    /**
     * Required. The parent resource where this TemplateVersion will be created. Format: projects/{project\}/location/{location\}/product/{product\}/integrationtemplates/{integrationtemplate\}
     */
  ...
  export interface Params$Resource$Projects$Locations$Products$Integrationtemplates$Versions$Get
    extends StandardParameters {
    /**
     * Required. The TemplateVersion to retrieve. Format: projects/{project\}/locations/{location\}/products/{product\}/integrationtemplates/{integrationtemplate\}/versions/{version\}
     */
  ...
  export interface Params$Resource$Projects$Locations$Products$Integrationtemplates$Versions$List
    extends StandardParameters {
    /**
     * Filter syntax: defined in the EBNF grammar.
     */
  ...
  export class Resource$Projects$Locations$Products$Sfdcinstances {
    ...
    create(
      ...
      const parameters = {
        options: Object.assign(
          {
            url: (rootUrl + '/v1alpha/{+parent}/sfdcInstances').replace(
              /([^:]\/)\/+/g,
              '$1'
            ),
            method: 'POST',
