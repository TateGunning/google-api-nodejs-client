...
export namespace securitycenter_v1 {
  ...
  export class Resource$Folders$Assets {
     ...
     *     // Required. Name of the parent to groupBy. Its format is "organizations/[organization_id], folders/[folder_id], or projects/[project_id]".
     ...
     *     // Required. Name of the parent assets should belong to. Its format is "organizations/[organization_id], folders/[folder_id], or projects/[project_id]".
     *     parent: 'folders/my-folder',
     *     // Time used as a reference point when filtering assets. The filter is limited to assets existing at the supplied time and their values are those at that specific time. Absence of this field will default to the API's version of NOW.
  ...
  export class Resource$Folders$Bigqueryexports {
     ...
     *     // Required. Resource name of the new BigQuery export's parent. Its format is "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
     *     parent: 'folders/my-folder',
     *
     *     // Request body metadata
     *     requestBody: {
     ...
     *     // Required. Name of the BigQuery export to delete. Its format is organizations/{organization\}/bigQueryExports/{export_id\}, folders/{folder\}/bigQueryExports/{export_id\}, or projects/{project\}/bigQueryExports/{export_id\}
  ...
  export class Resource$Folders$Notificationconfigs {
     ...
     *     pageToken: 'placeholder-value',
     *     // Required. Name of the parent to list notification configs. Its format is "organizations/[organization_id]", "folders/[folder_id]", or "projects/[project_id]".
     *     parent: 'folders/my-folder',
     *   });
     *   console.log(res.data);
     *
